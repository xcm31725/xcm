...
import cn.itcast.main.bos.service.transit.InOutStorageInfoService;
...
public class InOutStorageInfoAction extends BaseAction<InOutStorageInfo> {
	...
	@Action(value="inoutstore_save", results={@Result(name="success", type="redirect", location="pages/transitinfo.html")})
	public String save() {
