...
<script type="text/javascript">
	...
	/* $(function(){
		$.post("${ pageContext.request.contextPath }/CategoryServlet",{"method":"findAll"},function(data){
			//alert(data);	
			$(data).each(function(i,n){
				$("#menuID").append("<li><a href='${ pageContext.request.contextPath }/ProductServlet?cid="+n.cname+"&method=findByCid&currPage=1'>"+n.cname+"</a></li>")
			});
		},"json");
	}); */
</script>	
			...
			<div class="container-fluid">
				...
				<div class="col-md-3" style="padding-top:20px">
					<%-- <ol class="list-inline">
						...
						<li><a href="${ pageContext.request.contextPath }/UserServlet?method=logOut">购物车</a></li>
					</ol> --%>
					<ol class="list-inline">
